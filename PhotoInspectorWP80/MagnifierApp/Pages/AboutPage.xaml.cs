...
namespace MagnifierApp.Pages
{
    public partial class AboutPage : PhoneApplicationPage
    {
        public AboutPage()
        {
            ...
            projectsLink.Inlines.Add(AppResources.AboutPage_Hyperlink_Projects);
            ...
            var legalRun = new Run()
            {
                Text = AppResources.AboutPage_LegalRun_Text
            };

            LegalParagraph.Inlines.Add(legalRun);
        }
        ...
        private void ProjectsLink_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Uri = new Uri(AppResources.AboutPage_Hyperlink_Projects, UriKind.Absolute)
            };
